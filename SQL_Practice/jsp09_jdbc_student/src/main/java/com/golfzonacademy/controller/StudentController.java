 ...
 */
@WebServlet({"/s_insert.do", "/s_img_insertOK.do", "/s_insertOK.do", "/s_selectAll.do", "/json_dept_id.do", "/json_major_id.do"})
public class StudentController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (sPath.equals("/s_selectAll.do")) {
            ...
            request.getRequestDispatcher("student/selectAll.jsp")
        ...
        } else if (sPath.equals("/s_img_insertOK.do")) {
...
//			out.print("[\"SOFT_DEV\",\"SOFT_WEB\",\"ST_SAL\"]");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (sPath.equals("/s_img_insertOK.do")) {
            ...
            request.getRequestDispatcher("student/insert.jsp")
                    .forward(request, response);
        }
    }
