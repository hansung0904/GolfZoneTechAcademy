...
public class MemberMethodInterceptorImpl implements MethodInterceptor {
	private static final Logger logger = LoggerFactory.getLogger(MemberMethodInterceptorImpl.class);
